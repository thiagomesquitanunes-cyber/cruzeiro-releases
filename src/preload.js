...
const api = {
  ...
  irpfReport:           (d) => ipcRenderer.invoke('irpf:report', d),
  irpfSaveOverride:      (d) => ipcRenderer.invoke('irpf:save-override', d),
  irpfSaveDebtOverride:  (d) => ipcRenderer.invoke('irpf:save-debt-override', d),
  reportExportPdf:       (d) => ipcRenderer.invoke('report:export-pdf', d),
  ...
  aiDiagnoseFaturaGap: (d) => ipcRenderer.invoke('ai:diagnose-fatura-gap', d),
  ...
  patFinancingContractsList: (d) => ipcRenderer.invoke('pat:financing-contracts-list', d),
  ...
  patFinancingScheduleReal: (d) => ipcRenderer.invoke('pat:financing-schedule-real', d),
  patFinancingTogglePaid:   (d) => ipcRenderer.invoke('pat:financing-toggle-paid', d),
  patFinancingContractClose: (d) => ipcRenderer.invoke('pat:financing-contract-close', d),
  saveLang:    (lang) => ipcRenderer.invoke('settings:save-data', { language: lang }),
  licenseStatus:     ()            => ipcRenderer.invoke('license:status'),
  licenseDebugOverride: (value)    => ipcRenderer.invoke('license:debug-override', { value }),
  ...
  debtContractGet:     (d)   => ipcRenderer.invoke('debt:contract-get', d),
  debtContractSave:    (d)   => ipcRenderer.invoke('debt:contract-save', d),
  debtMarkPaid:        (d)   => ipcRenderer.invoke('debt:mark-paid', d),
  debtScheduleReal:    (d)   => ipcRenderer.invoke('debt:schedule-real', d),
  debtTogglePaid:      (d)   => ipcRenderer.invoke('debt:toggle-paid', d),
  debtUnpay:           (d)   => ipcRenderer.invoke('debt:unpay', d),
  debtInstallmentSet:  (d)   => ipcRenderer.invoke('debt:installment-set', d),
  ...
  brokerLabelPrefGet: (d)    => ipcRenderer.invoke('broker:label-pref-get', d),
  brokerLabelPrefSet: (d)    => ipcRenderer.invoke('broker:label-pref-set', d),
  brokerMappingLearn:  (d)   => ipcRenderer.invoke('broker:mapping-learn', d),
  brokerLearnedItemsGet:  ()  => ipcRenderer.invoke('broker:learned-items-get'),
  ...
  mlUpdate:       (d)     => ipcRenderer.invoke('ml:update', d),
  mlDelete:       (d)     => ipcRenderer.invoke('ml:delete', d),
